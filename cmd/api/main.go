...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "ef08c05566837a", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "9538d424c2c421", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@greenlight.jeremiahh34.net>", "SMTP sender")
